    ...
    renderItem(item, index) {
        return (
            <TouchableOpacity onPress={() => Actions.MessageDetail({ msgData: item, flag: "mine" })}>
                <View style={{ height: 56, marginHorizontal: 15, margin: 1, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.C8, borderBottomWidth: 1, borderColor: Colors.LightGrey, borderRadius: 5 }}>
...
const Styles = StyleSheet.create({
    ...
    text: { marginTop: 8, fontSize: 13, color: Colors.greyText }
});