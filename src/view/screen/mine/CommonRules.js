 ...
 * @Last Modified time: 2020-09-16 18:38:30
 */
...
const Styles = StyleSheet.create({
    ...
    ruleText: { marginTop: 10, fontSize: 14, lineHeight: 19, color: Colors.main },
    verticalLine: { height: 20, width: 10, backgroundColor: Colors.mainTab,marginTop:2 },
});
