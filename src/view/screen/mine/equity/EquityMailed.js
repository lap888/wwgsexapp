    ...
    render() {
        return (
            <View>
                ...
                <TouchableOpacity style={{marginHorizontal: 20, justifyContent: 'center', borderRadius: 5, alignItems: 'center', height: 40, marginTop: 15, backgroundColor: Colors.mainTab}}>
