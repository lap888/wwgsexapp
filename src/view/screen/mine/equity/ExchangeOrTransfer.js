        ...
        return (
            <View style={{backgroundColor: Colors.White, marginTop: 15, marginHorizontal: 15, borderRadius: 10, paddingBottom: 20 }}>
                <View style={{flexDirection: 'row', height: 40, marginBottom: 10}}>
                    <TouchableOpacity style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: type == 'exchange' ? Colors.mainTab : Colors.White, borderTopLeftRadius: 10}}
                        onPress={()=> this.setState({type: 'exchange'})}>
                        <Text style={{color: type == 'exchange' ? Colors.White : Colors.C12}}>兑换</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: type == 'transfer' ? Colors.mainTab : Colors.White, borderTopRightRadius: 10}}
                ...
                {type == 'exchange' ? <View style={{paddingHorizontal: 10}}>
                    <View style={styles.inputView}>
                        <TextInput
                            ...
                            placeholder={`兑换股权数量 (${data.unitPrice ? data.unitPrice  : ''}${data.unitPrice ? data.unitPrice : ''}果皮兑换1股)`}
...
const styles = StyleSheet.create({
    btn: {backgroundColor: Colors.mainTab, height: 40, marginHorizontal: 20, justifyContent: 'center', alignItems: 'center', marginTop: 20, borderRadius: 20},
