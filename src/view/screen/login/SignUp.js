        ...
        return (
            <View style={{flex: 1}}>
                ...
                <LinearGradient colors={[Colors.C6, Colors.LightG]} start={{ x: 0, y: 0.1 }} end={{ x: 0, y: 1 }} style={{ flex: 1 }}>
                    <View>
                        <View style={{height: 60, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, borderBottomWidth: StyleSheet.hairlineWidth, }}>
                            <TextInput 
                                style={styles.text} 
                        ...
                        <View  style={{height: 60, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, borderBottomWidth: StyleSheet.hairlineWidth, }}>
                            <TextInput style={styles.text} placeholder="请输入验证码" placeholderTextColor={Colors.White} onChangeText={(value) => this.setState({ vcode: value })}
                                returnKeyType="done"
