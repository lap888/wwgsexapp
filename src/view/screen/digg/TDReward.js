 ...
 * @Last Modified time: 2020-06-04 23:07:21
 */
...
const BaseScript =
    ...
    `
export default class TDReward extends Component {
    constructor(props) {
        super(props);
        this.state = {
            height: 0,
        ...
        return (
            <View style={{ flex: 1, backgroundColor: Colors.C8 }}>
                <WebView
                    ...
                    source={Platform.OS === 'android' ? { uri: gUrl, baseUrl: "", headers: { token: this.props.token } } : { uri: gUrl }}
                />
            </View>
        );
    }
