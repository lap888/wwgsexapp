 ...
 * @Last Modified time: 2021-06-05 23:54:16
 */
...
export default class TDetailContent extends Component {
    ...
    render() {
        ...
        <body>
        <p style="color:#0cb585;font-size:20px">标题：${this.props.title}</p>
    ...
    // render() {
    //     return (
    //         <View style={{ height: this.state.webViewHeight, width: Metrics.screenWidth }}>
    //             <WebView
    //                 source={{
    //                     html:
    //                         `<!DOCTYPE html>
