                ...
                <View style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={3} placeholder="适用于需要点击链接，访问网页的操作，输入内容，提示打开网页相关注意事项" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                        value={inputUrlDesc}
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} placeholder="链接" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                        value={inputUrl}
                ...
                <ScrollView style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={3} placeholder="适用于图片说明引导悬赏人操作，输入内容，详细说明需要注意哪些事项" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                ...
                                <View style={{ marginLeft: 10, paddingLeft: 8, width: Metrics.screenWidth * 0.7 * 0.8, }}>
                                    <TouchableOpacity onPress={() => this.handleImagePicker('inputPicAndTxt')}>
                                        <View style={Styles.uploadView}>
                                            <Text style={{ color: Colors.C16, fontSize: 14 }}>选择图片</Text>
                                        </View>
                                    </TouchableOpacity>
                                    {this.state.inputPicAndTxtImage != '' ?
                                        ...
                                        <View style={[Styles.screenshotImg, { justifyContent: 'center', alignItems: 'center' }]}>
                                            <Icon name="ios-image-outline" color={Colors.mainTab} size={60} />
                                        </View>
                                    }
                                </View>
                            </View>
                ...
                <ScrollView style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={3} placeholder="适用于需要扫二维码的操作，输入内容，详细说明需要注意哪些事项" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                ...
                <View style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={3} placeholder="适用于需要复制数据，如填写邀请码，输入内容会提示会员复制数据方便填写" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                        value={copyDataDesc}
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} placeholder="如邀请码，钱包之类地址" placeholderTextColor={Colors.White} underlineColorAndroid="transparent" keyboardType="numeric"
                ...
                <ScrollView style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={5} placeholder="适用于收集截图结果。输入内容，详细说明自己需要哪个界面，符合说明要求等。并且上传截图示例" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                        value={findPicDesc}
                ...
                <View style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={Styles.modalBody}>
                        ...
                        <View style={[Styles.modalBodyPrice, { marginTop: 40 }]}>
                            ...
                            <View style={Styles.modalBodyRight}>
                                <View style={Styles.textInputContainer}>
                                    <TextInput style={Styles.publishTextInput} multiline={true} numberOfLines={3} placeholder="适用于收集手机号，用户名，ID等。输入内容详细说明你需要收集什么内容！" placeholderTextColor={Colors.White} underlineColorAndroid="transparent"
                                        value={findTxtDesc}
        ...
        ImagePicker.showImagePicker(options, (response) => {
            ...
            if (response.didCancel) {
                ...
                if (key == 'inputPicAndTxt') {
                    that.setState({ inputPicAndTxtImage: 'data:image/jpg;base64,' + response.data });
                } else if (key == 'inputQrCode') {
                    that.setState({ inputOrCodeImage: 'data:image/jpg;base64,' + response.data });
                } else if (key == 'findPic') {
                    that.setState({ findPicImage: 'data:image/jpg;base64,' + response.data });
                }
                else { }
            }
        });
            ...
            <SafeAreaView style={{ backgroundColor: Colors.White, flex: 1 }}>
                ...
                <View style={{height: 45, }}>
                    ...
                    {/* <Item picker>
                        <Picker
                            mode="dropdown"
                            iosIcon={<Icon name="apps" />}
                            style={{ width: Metrics.screenWidth }}
                            placeholder="添加步骤"
                            placeholderStyle={{ color: Colors.C16 }}
                            placeholderIconColor="#007aff"
                            selectedValue='添加步骤'
                            onValueChange={this.onPressAddStep.bind(this)}
                        >
                            <Picker.Item label="添加步骤" value="addStep" />
                            <Picker.Item label="输入网址" value="inputUrl" />
                            <Picker.Item label="图文说明" value="inputPicAndTxt" />
                            <Picker.Item label="传二维码" value="inputQrCode" />
                            <Picker.Item label="复制数据" value="copyData" />
                            <Picker.Item label="收集截图" value="findPic" />
                            <Picker.Item label="收集信息" value="findTxt" />
                        </Picker>
                    </Item> */}
                </View>
                <ScrollView style={{flex:1}}>
                            ...
                            return (
                                <View style={[Styles.stepHeader,{ height: 40, borderBottomColor: Colors.C7, marginLeft: 10}]} key={v.id}>
                                    ...
                                    <TouchableOpacity onPress={() => this.delTaskStep(v.id)}>
                                        <Icon size={20} style={{ color: Colors.mainTab }} name="close-circle-outline" />
                                    </TouchableOpacity>
                                </View>
                            )
                        })}
