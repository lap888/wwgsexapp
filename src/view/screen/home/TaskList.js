                    ...
                    <LinearGradient colors={[item.colors, Colors.LightG]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={Styles.miningItem}>
                        <View style={Styles.miningItemHeader}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <Text style={[Styles.miningItemGemin, { marginLeft: 10 }]}>{`兑换所需：${item.candyIn}个`}</Text>
                            </View>
                        </View>
                        <View style={Styles.miningItembody}>
                            <View>
                                <Text style={Styles.miningItemGemout}>{`总产出：${item.candyOut}个`}</Text>
                                <Text style={Styles.miningItemActivity}>{`日产出：${item.candyH}个`}</Text>
                                ...
                                <Text style={[Styles.miningItemActivity]}>{`兑换送：${item.teamH}团队果核`}</Text>
