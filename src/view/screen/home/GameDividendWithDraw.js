...
class GameDividendWithDraw extends Component {
    ...
    checkWithDraw() {
        ...
        if (withdrawNumber >= 10 && withdrawNumber <= this.props.userBalanceNormal) {
            return true;
        }
        return false;
    }
...
const Styles = StyleSheet.create({
    ...
    withDraw: { alignSelf: 'center', width: Metrics.screenWidth * 0.6, marginTop: 30, paddingTop: 14, paddingBottom: 14, backgroundColor: Colors.mainTab, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
    ...
    withDrawAllText: { fontSize: 15, color: Colors.mainTab },
