 ...
 * @Last Modified time: 2021-02-23 10:14:28
 */
            ...
            <View style={Styles.transaction}>
                <View style={Styles.body}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 8 }}>
                        ...
                        <Text style={Styles.number}>{`${amount}NW`}</Text>
                    </View>
                ...
                <View style={{alignItems: 'flex-end', justifyContent: 'center',}}>
                    <Text style={[Styles.price, { color: Colors.C11 }]}>{`单价`}</Text>
                    <Text style={[Styles.price,{fontWeight: 'bold',fontSize: 16,marginVertical: 10,}]}>{`￥${price}`}</Text>
                    <LinearGradient colors={[Colors.btnBeforColor, Colors.btnAfterColor]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ alignItems: 'center', justifyContent: 'center', borderRadius: 5 }}>
