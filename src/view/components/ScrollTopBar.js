...
export default class ScrollTopBar extends Component {
    ...
    renderTopBar() {
        return (
            <View style={this.props.borderBottom ? Styles.fabottom : {}}>
                <ScrollView
                            ...
                            {this.props.labelList.map((item, index) => {
                                ...
                                return (
                                    <TouchableWithoutFeedback key={index} onPress={() => this.switchTopBar(index)} key={index}>
                                        ...
                                        >
                                            <Text style={[{ color: this.props.topBarInactiveTextColor }, this.props.textStyles, check && { color: this.props.topBarActiveTextColor }]}>{title}</Text>
                                        </View>
