                    ...
                    return (
                        <TouchableOpacity key={index} style={styles.item} onPress={() => this.select(item)}>
                            <View style={styles.itemTxtView}>
                                <Text style={{ color: this.state.data.key === item.key ? Colors.mainTab : Colors.C12,}}>{item.name}</Text>
                            </View>
                            <View style={{height: 2, width: 80, backgroundColor: this.state.data.key === item.key ? Colors.mainTab : Colors.White}}/>
                        </TouchableOpacity>
                    )
                })}
