...
class ScrollArea extends Component {
    ...
    renderTopBar() {
        ...
        return (
            <View style={{ backgroundColor: this.props.topBarBackgroundColor, padding: 10, paddingLeft: 15, paddingRight: 15, width: Metrics.width/3*2 }}>
                            ...
                            <TouchableWithoutFeedback key={index} onPress={() => this.switchTopBar(index)} key={index}>
                                <View
                                    ...
                                    style={{
                                        ...
                                        borderColor: '#FFFFFF', 
                                        backgroundColor: check ? topBarActiveBackgroundColor : topBarInactiveBackgroundColor,
                                        width: 80
                                    }}
                                >
                                    <Text style={{ fontSize: 14, color: check ? topBarActiveTextColor : topBarInactiveTextColor }}>{title}</Text>
                                </View>
