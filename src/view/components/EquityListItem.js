                ...
                <BoxShadow setting={shadowOpt} key={index}>
                    <View style={{flexDirection: 'row', backgroundColor: Colors.White, height: 60, margin: 1, borderRadius: 6}}>
                        ...
                        <View style={{paddingHorizontal: 10, justifyContent: 'center'}}>
                            <Text style={{fontSize: 18, color: Colors.mainTab}}>{item.incurred > 0 ? `+${item.incurred}` : item.incurred}</Text>
                        </View>
                    </View>
                </BoxShadow>
            );
            ...
            return (
                <BoxShadow setting={shadowOpt} key={index}>
                    <View style={{flexDirection: 'row', backgroundColor: Colors.White, height: 60, margin: 1, borderRadius: 6}}>
                        ...
                        <View style={{paddingHorizontal: 10, justifyContent: 'center'}}>
                            <Text style={{fontSize: 18, color: Colors.mainTab}}>{item.occurAmount}</Text>
                        </View>
                    </View>
                </BoxShadow>
            );
